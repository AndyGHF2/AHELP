...
class Updater
{
  ...
  Updated() {
    ...
    MsgBox, % "AdminHelper óñïåøíî îáíîâë¸í äî âåðñèè " Config["About"]["Version"] " (" Config["About"]["LastUpdate"] ").`nÆåëàåì ïðèÿòíîãî ïîëüçîâàíèÿ.`n`nÏîñëå íàæàòèÿ êíîïêè ""OK"" çàïóñòèòñÿ AdminHelper."
  ...
  CheckUpdate() {
    ...
    if (Config["About"]["Version"] < Repository_Data["tag_name"]) {
      MsgBox, 4, , % "Äîñòóïíî îáíîâëåíèå AdminHelper.ahk:`nÂåðñèÿ: " Repository_Data["tag_name"] ".`n`n×òî íîâîãî:`n`n" StrReplace(Repository_Data["body"], "\r\n", "`n") "`n`nÂû æåëàåòå îáíîâèòüñÿ ïðÿìî ñåé÷àñ?"
      IfMsgBox, Yes
      {
