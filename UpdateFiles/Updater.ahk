...
; SAMP Addresses
global ADDR_SAMP_INCHAT_PTR             := 0x20DFFC ; Ðàáîòàåò | Ñïàñèáî - Drygok
global ADDR_SAMP_INCHAT_PTR_OFF         := 0x55 ; Ðàáîòàåò | Ñïàñèáî - Drygok
...
global FUNC_SAMP_ADDTOCHATWND           := 0x60C50 ; CR:MP 0.3e | Ðàáîòàåò
global ADDR_SAMP_CHATMSG_PTR            := 0x20DFD8 ; CR:MP 0.3e | Ðàáîòàåò
; ########################## Dialog Styles ##########################
...
global SAMP_DIALOG_STRUCT_PTR				:= 0x20DFAC ; | Ðàáîòàåò
global SAMP_DIALOG_PTR1_OFFSET				:= 0x1C ; | Ðàáîòàåò
global SAMP_DIALOG_LINES_OFFSET 			:= 0x44C ; | Ðàáîòàåò
global SAMP_DIALOG_INDEX_OFFSET				:= 0x443 ; | Ðàáîòàåò
global SAMP_DIALOG_BUTTON_HOVERING_OFFSET	:= 0x465 ; | Ðàáîòàåò
global SAMP_DIALOG_BUTTON_CLICKED_OFFSET	:= 0x466 ; | Ðàáîòàåò
global SAMP_DIALOG_PTR2_OFFSET 				:= 0x20 ; | Ðàáîòàåò
global SAMP_DIALOG_LINECOUNT_OFFSET			:= 0x150 ; | Ðàáîòàåò
global SAMP_DIALOG_OPEN_OFFSET				:= 0x28 ; | Ðàáîòàåò
global SAMP_DIALOG_STYLE_OFFSET				:= 0x2C ; | Ðàáîòàåò
global SAMP_DIALOG_ID_OFFSET				:= 0x30 ; | Ðàáîòàåò
global SAMP_DIALOG_TEXT                     := 0x12D8F8
global SAMP_DIALOG_TEXT_PTR_OFFSET			:= 0x34
global SAMP_DIALOG_CAPTION_OFFSET			:= 0x40
global FUNC_SAMP_SHOWDIALOG				 	:= 0x668C0 ; Ðàáîòàåò | Ñïàñèáî - Drygok
...
; #########################################################################################################################################################
; # 														                                                                                                                             
; #     - IsSAMPAvailable()                                         - Ñîñòîÿíèå SAMP (0 - Çàïóùåí, 1 - Âûêëþ÷åí) ; Íå ðàáîòàåò
; #     - isInChat()                                                - Îòêðûò ëè ÷àò (0 - íåò, 1 - äà) ; Íå ðàáîòàåò
; #     - getUsername()                                             - Âûâîäèò òâîé íèê
; #     - getId()                                                   - Âûâîäèò òâîé èä
; #     - SendChat(wText)                                           - Îòïðàâêà ñîîáùåíèÿ â ÷àò íå îòêðûâàÿ åãî(÷åðåç ïàìÿòü) ; Ðàáîòàåò
; #     - addChatMessage(wText)                                     - Îòïðàâèòü ôåéê ñîîáùåíèå â ÷àò ; Ðàáîòàåò
; #     - showGameText(wText, dwTime, dwTextsize)                   - Ïîêàçàòü GUI òåêñò (íå ðàáîòàåò ñ ðóññêèì ÿçûêîì) ; Íå ïðîâåðÿë
; #     - playAudioStream(wUrl)                                     - Ïðîèãðûâàåò ïåñíþ ïî url ; Íå ïðîâåðÿë
; #     - stopAudioStream()                                         - Îñòàíàâëèâàåò ïðîèãðûâàíèå ; Íå ïðîâåðÿë
; #	    - GetChatLine(Line, Output)                                 - Âûâîä ñòðîêè èç ÷àò ëîãà (Line=0 - Ýòî ïîñëåäíÿÿ ñòðîêà) (Output - âûâîä òåêñòà) ; Íå ïðîâåðÿë
; #
; # 	- blockChatInput() 	                                        - Çàáëîêèðîâàòü ïèñàòü â ÷àò ; Ðàáîòàåò
; # 	- unBlockChatInput()                                        - Ðàçðåøèòü ïèñàòü â ÷àò (îáðàòíîå ïðåäûäóùåìó) ; Ðàáîòàåò
; ###############################################################################################################################
; # 														                                                                    
; #     - getServerName()                                           - Íàçâàíèå ñåðâåðà ; Íå ðàáîòàåò
; #     - getServerIP()                                             - IP ñåðâåðà ; Íå ðàáîòàåò
; #     - getServerPort()                                           - Ïîðò ñåðâåðà ; Íå ðàáîòàåò
; #     - CountOnlinePlayers()                                      - Êîë-âî ÷åëîâåê íà ñåðâåðå ; Íå ðàáîòàåò
; # 														                                                                   
; ###############################################################################################################################
; # 											
; #	    - getWeatherID()			                                -  ÈÄ ïîãîäû ; Íå ïðîâåðÿë
; #	    - getWeatherName()	                                        -  Íàçâàíèå ïîãîäû ; Íå ïðîâåðÿë
; # 														                                             
; ###############################################################################################################################
; # 														                                             
; #     - patchRadio() (interner stuff) ; Íå ïðîâåðÿë										                         
; #     - unPatchRadio() (interner stuff)		; Íå ïðîâåðÿë									                     
; # 														                                             
; ###############################################################################################################################
; #							
; #     - setDialogState(0)                                         - Ñêðûòü äèàëîã ; | Ðàáîòàåò
; #     - setDialogState(1)                                         - Îòîáðàçèòü ñêðûòûé äèàëîã ; | Ðàáîòàåò
; #	    - isDialogOpen()                                            - Åñëè îòêðûò äèàëîã 1, åñëè íå îòêðûò 0 ; | Ðàáîòàåò 
; #	    - getDialogStyle()                                          - Ñòèëü äèàëîãà 0-5 ; | Ðàáîòàåò                                           
; #	    - getDialogID()                                             - Èä äèàëîãà ; | Ðàáîòàåò                              
; # 	- setDialogID(id)                                           - Óñòàíîâèòü èä äèàëîãó ; | Íå òåñòèðîâàë
; # 	- getDialogIndex()                                          - Âûâîä âûáðàíîé ëèíèè (÷èñëî) ; | Äëÿ ÷åãî îíà?)    
; #     - getDialogLineNumber()                                     - Âûâîä âûáðàíîé ëèíèè (÷èñëî) Çàìåíà getDialogIndex() ; | Ðàáîòàåò        
; #	    - getDialogCaption()                                        - Âûâîä íàçâàíèÿ äèàëîãà   ; | Ðàáîòàåò          	         
; #	    - getDialogText()                                           - Âûâîä òåêñòà èç äèàëîãà; | Ðàáîòàåò
; #	    - getDialogLineCount()                                      - Âñåãî ñòðîê â äèàëîãå  ; | Íå êîðåêòíî                
; # 	- getDialogLine(index)                                      - Âûâîäèò òåêñò èç ñòðîêè ; | Ðàáîòàåò
; # 	- getDialogLines()                                          - Âîçâðàùàåò ìàññèâ ñòðîê ñ äèàëîãà   ; | Íå òåñòèðîâàë                               
; # 	- isDialogButton1Selected()                                 - PrÃ¼ft, ob Button1 des Dialogs ausgewÃ¤hlt ist  ; | Íå òåñòèðîâàë
; #     - getDialogStructPtr()                                      - Liest den Base Pointer zur Dialogstruktur aus (intern genutzt) ; | Ðàáîòàåò
; # 	- showDialog(style, caption, text, button1, button2, id)    - Ïîêàçûâàåò âèçóàëüíûé äèàëîã  ; | Íå ðàáîòàåò
; #
; ###############################################################################################################################
; # 														                                                                                                                      
; #	    - getTargetPed(dwPED)   			                        - Âîçâðàùàåò PED ID, ïî òàðãåòó                                  
; #     - getPedById(dwId)                                          - Âîçâðàùàåò PED ID ïî id èãðîêà   
; #     - getIdByPed(dwId)                                          - Èä ïî òàðãåòó (getIdByPed(getTargetPed()))
; #     - getStreamedInPlayersInfo()                                - Ïîëó÷èòü èíôîðìàöèþ îá èãðîêàõ â ðàäèóñå ñòðèìà
; #     - callFuncForAllStreamedInPlayers()                         - Ïîëó÷èòü âñþ èíôîðìàöèþ îá èãðîêàõ â ðàäèóñå ñòðèìà
; #	    - getDist(pos1,pos2)   			                            - Ïîëó÷èòü äèñòàíöèþ ìåæäó äâóìÿ êîîðäèíàòàìè 
; #     - getClosestPlayerPed()                                     - Âîçâðàùàåò PED ID áëèæàéøåãî èãðîêà                                      
; #     - getClosestPlayerId()                                      - Âîçâðàùàåò id áëèæàéøåãî èãðîêà                                          
; #	    - getPedCoordinates(dwPED)   			                    - Âîçâðàùàåò êîðäèíàòû (â çîíå ñòðèìà) ïî PED ID                           
; #     - getPlayerPosById(dwId)                                    - Âîçâðàùàåò ïîçèöèþ èãðîêà ïî id                                          
; #     - getTargetPlayerSkinIdByPed(dwPED)                         - Âîçâðàùàåò id ñêèíà ïî PED ID                                             
; #     - getTargetPlayerSkinIdById(dwId)                           - Âîçâðàùàåò id ñêèíà ïî id èãðîêà                                          
; #     - calcScreenCoors(fX,fY,fZ)                                 - Âîçâðàùàåò ìàññèâ êîîðäèíàò [fX,fY,fZ] îòíîñèòåëüíî ýêðàíà                  
; # 														                                                                                                                              
; #	    - getVehiclePointerByPed(dwPED)   			                - Âîçâðàùàåò óêàçàòåëü íà òðàíñïîðò ïî PED ID                               
; #	    - getVehiclePointerById(dwId)   			                - Âîçâðàùàåò óêàçàòåëü íà òðàíñïîðò ïî id èãðîêà                            
; #     - isTargetInAnyVehicleByPed(dwPED)                          - Ïðîâåðÿåò íàõîäèòñÿ ëè èãðîê â òðàíñïîðòå ïî PED ID                       
; #     - isTargetInAnyVehicleById(dwId)                            - Ïðîâåðÿåò íàõîäèòñÿ ëè èãðîê â òðàíñïîðòå ïî id èãðîêà                    
; #     - getTargetVehicleHealthByPed(dwPED)                        - Âîçâðàùàåò hp òðàíñïîðòà ïî PED ID                                        
; #     - getTargetVehicleHealthById(dwId)                          - Âîçâðàùàåò hp òðàíñïîðòà ïî id èãðîêà                                     
; #     - getTargetVehicleTypeByPed(dwPED)                          - Âîçâðàùàåò òèï òðàíñïîðòà ïî PED ID (âîçâðàùàåò ÷èñëî, à íå íàçâàíèå)     
; #     - getTargetVehicleTypeById(dwId)                            - Âîçâðàùàåò òèï òðàíñïîðòà ïî id èãðîêà (âîçâðàùàåò ÷èñëî, à íå íàçâàíèå)  
; #     - getTargetVehicleModelIdByPed(dwPED)                       - Âîçâðàùàåò íîìåð ìîäåëè òðàíñïîðòà ïî PED ID                              
; #     - getTargetVehicleModelIdById(dwId)                         - Âîçâðàùàåò íîìåð ìîäåëè òðàíñïîðòà ïî id èãðîêà                           
; #     - getTargetVehicleModelNameByPed(dwPED)                     - Âîçâðàùàåò íàçâàíèå ìîäåëè òðàíñïîðòà ïî PED ID 				            
; #     - getTargetVehicleModelNameById(dwId)                       - Âîçâðàùàåò íàçâàíèå ìîäåëè òðàíñïîðòà ïî id èãðîêà 				        
; #     - getTargetVehicleLightStateByPed(dwPED)                    - Âîçâðàùàåò ñîñòîÿíèå ñâåòà òðàíñïîðòà ïî PED ID (âêë./âûêë.)			    
; #     - getTargetVehicleLightStateById(dwId)                      - Âîçâðàùàåò ñîñòîÿíèå ñâåòà òðàíñïîðòà ïî id èãðîêà (âêë./âûêë.)		    
; #     - getTargetVehicleEngineStateByPed(dwPED)                   - Âîçâðàùàåò ñîñòîÿíèå ìîòîðà òðàíñïîðòà ïî PED ID (âêë./âûêë.)			    
; #     - getTargetVehicleEngineStateById(dwId)                     - Âîçâðàùàåò ñîñòîÿíèå ìîòîðà òðàíñïîðòà ïî id èãðîêà (âêë./âûêë.) 			
; #     - getTargetVehicleLockStateByPed(dwPED)                     - Âîçâðàùàåò ñîñòîÿíèå äâåðåé òðàíñïîðòà ïî PED ID (çàêðûòû/îòêðûòû) 	    
; #     - getTargetVehicleLockStateById(dwId)                       - Âîçâðàùàåò ñîñòîÿíèå äâåðåé òðàíñïîðòà ïî id èãðîêà (çàêðûòû/îòêðûòû)     
; #     - getTargetVehicleColor1ByPed(dwPED)                        - Âîçâðàùàåò 1-é öâåò òðàíñïîðòà ïî PED ID 			                        
; #     - getTargetVehicleColor1ById(dwId)                          - Âîçâðàùàåò 1-é öâåò òðàíñïîðòà ïî id èãðîêà			                    
; #     - getTargetVehicleColor2ByPed(dwPED)                        - Âîçâðàùàåò 2-é öâåò òðàíñïîðòà ïî PED ID 			                        
; #     - getTargetVehicleColor2ById(dwId)                          - Âîçâðàùàåò 2-é öâåò òðàíñïîðòà ïî id èãðîêà 			                    
; #     - getTargetVehicleSpeedByPed(dwPED)                         - Âîçâðàùàåò òåêóùóþ ñêîðîñòü òðàíñïîðòà ïî PED ID			               
; #     - getTargetVehicleSpeedById(dwId)                           - Âîçâðàùàåò òåêóùóþ ñêîðîñòü òðàíñïîðòà ïî id èãðîêà		               
; # 														                                             
; ############################################################################################################################################ ;
; #                                                                                                                                          # ;
; #     - getPlayerScoreById(dwId)                 - Óðîâåíü èãðîêà ïî ID 
; #     - getPlayerPingById(dwId)                  - Ïèíã ïî ID
; #     - getPlayerNameById(dwId)                  - Íèê ïî ID
; #     - getPlayerIdByName(wName)                 - ID ïî Íèêó
; #     - updateScoreboardDataEx()                 - Îáíîâèòü èíôîðìàöèþ â òàáå        
; #     - updateOScoreboardData()                  - Îáíîâèòü èíôîðìàöèþ â òàáå      
; #	    - isNPCById(dwId)   		               - ßâëÿåòüñÿ ëè äàííûé èä NPC èëè íåò
; #                                                                                                                                          # ;
; ############################################################################################################################################ ;
; #                                                                                                                                          # ;
; #     - getWeaponAmmo()                          -    1) Ammo - âîçâðàùàåò â ïåðåìåííóþ îáùåå êîëè÷åñòâî ïàòðîí. 
; #                                                     2) Clip - âîçâðàùàåò â ïåðåìåííóþ êîëè÷åñòâî ïàòðîí â ìàãàçèíå
; #     - isPlayerCrouch()                         -    Ñîñòîÿíèå ïåðñîíàæà (1 - ñèäèò, 0 - ñòîèò, -1 - íå çàñïàíåí)
; #     - setHP(hp)                                -    Èçìåíèòü ñåáå ÕÏ
; #     - getPlayerHealth()                        -    Ïîêàçûâàåò êîë-âî õï
; #     - getPlayerArmor()                         -    Ïîêàçûâàåò êîë-âî áðîíè
; # 	- getPlayerInteriorId()			           -    ID èíòåðüåðà â êîòîðîì âû íàõîäèòåñü
; # 	- getPlayerSkinId()			               -    Ïîêàçûâàåò ID âàøåãî ñêèíà
; # 	- getPlayerMoney() 			               -    Ïîêàçûâàåò êîë-âî äåíåã
; #	    - getPlayerWanteds()			           -    Ïîêàçûâàåò êîë-âî çâåçä
; #	    - getPlayerWeaponId()			           -    Ïîêàçûâàåò ID îðóæèÿ â ðóêàõ
; #	    - getPlayerWeaponName()			           -    Ïîêàçûâàåò íàçâàíèå îðóæèÿ â ðóêàõ
; #	    - getPlayerState()			               -    Âîçâðàùàåò ñîñòîÿíèå ëîêàëüíîãî èãðîêà (âîçâðàùàåò ÷èñëî)    
; # 	- getPlayerMapPosX()			           -    Ïîçèöèÿ ïåðñîíàæà ïî êîîðäèíàòå X 
; # 	- getPlayerMapPosY()			           -    Ïîçèöèÿ ïåðñîíàæà ïî êîîðäèíàòå Y        
; # 	- getPlayerMapZoom()			           -    Îïðåäåëÿåò ìàñøòàá íà êàðòå â ìåíþ           
; # 	- IsPlayerFreezed()			               -    Îïðåäåëåÿåò çàìîðîæåí ëè èãðîê (0-Íå çàìîðîæåí, 1-Çàìîðîæåí)            
; #                                                                                                                                          # ;
; ############################################################################################################################################ ;
; #                                                                                                                                          # ;
; #     - isPlayerInAnyVehicle()                   -    Íàõîäèòåñü ëè âû â àâòîìîáèëå (0-Íåò, 1-Äà)         
; #     - getVehicleHealth()                       -    Êîë-âî HP ó ìàøèíû â êîòîðîé âû íàõîäèòåñü
; # 	- isPlayerDriver() 			               -    (-1 Âû íå â àâòîìîáèëå, 0 - Âû íà ïîñàæèðñêîì ñèäåíüå, 1 - Âû âîäèòåëü)		 
; # 	- getVehicleType() 			               -    Òèï àâòîìîáèëÿ â êîòîðîì âû íàõîäèòåñü
; # 	- getVehicleModelId()			           -    ID ìàøèíû â êîòîðîé íàõîäèòåñü
; # 	- getVehicleModelName() 		           -    Íàçâàíèå ìàøèíû
; # 	- getVehicleLightState() 		           -    Âêëþ÷åíû ëè ôàðû ìàøèíû â êîòîðîé íàõîäèòåñü
; # 	- getVehicleEngineState() 		           -    Çàâåäåí ëè äâèãàòåëü
; # 	- getVehicleLockState() 		           -    Çàêðûò ëè àâòîìîáèëü
; # 	- getVehicleColor1() 		               -    Öâåò 1 ìàøèíû
; # 	- getVehicleColor2() 		               -    Öâåò 2 ìàøèíû
; # 	- getVehicleSpeed() 		               -    Ñêîðîñòü àâòîìîáèëÿ
; # 	- getPlayerRadiostationID() 		       -    Èä ðàäèîñòàíöèè â àâòîìîáèëå		 
; # 	- getPlayerRadiostationName() 		       -    Íàçâàíèå ðàäèîñòàíöèè â àâòîìîáèëå		 		          
; #                                                                                                                                          # ;
; ############################################################################################################################################ ;
; #                                                                                                                                          # ;
; #     - getCoordinates()                          -   Âûâîä êîîðäèíàò íà êîòîðûõ íàõîäèòåñü                                                # ;
; #	    - getPlayerPos(X,Y,Z) 			            -   Âûâîä êîîðäèíàò íà êîòîðûõ âû íàõîäèòåñü â ïåðåìåííûå                                # ;
; #                                                                                                                                          # ;
; ############################################################################################################################################ ;
; #                                                                                                                                          # ;
; #     - initZonesAndCities()                      - Èíèöèàëèçàöèÿ ðàéîíîâ è ãîðîäîâ êàðòû                                     
; #     - calculateZone(X, Y, Z)                    - Âîçâðàùàåò íàçâàíèå ðàéîíà ïî êîîðäèíàòàì                                 
; #     - calculateCity(X, Y, Z)                    - Âîçâðàùàåò íàçâàíèå ãîðîäà ïî êîîðäèíàòàì                                 
; #     - getCurrentZonecode()                      - ..:: ÍÅ ÐÀÁÎÒÀÅÒ ::..                                                     
; #     - AddZone(Name, X1, Y1, Z1, X2, Y2, Z2)     - Äîáàâëåíèå íîâîãî ðàéîíà                                                  
; #     - AddCity(Name, X1, Y1, Z1, X2, Y2, Z2)     - Äîáàâëåíèå íîâîãî ãîðîäà                                                  
; #	    - IsPlayerInRangeOfPoint(X, Y, Z, Radius)   - Ïðîâåðÿåò íàõîäèòñÿ ëè ëîêàëüíûé èãðîê â ðàäèóñå 3D êîîðäèíàò             
; #	    - IsPlayerInRangeOfPoint2D(X, Y, Radius)  - Ïðîâåðÿåò íàõîäèòñÿ ëè ëîêàëüíûé èãðîê â ðàäèóñå 2D êîîðäèíàò             
; #	    - getPlayerZone()                   	    - Âîçâðàùàåò íàçâàíèå ðàéîíà ëîêàëüíîãî èãðîêà		                       
; #	    - getPlayerCity()                   	    - Âîçâðàùàåò íàçâàíèå ãîðîäà ëîêàëüíîãî èãðîêà                 					                                         
; #                                                                                                                                          # ;
; ############################################################################################################################################ ;
; #                                                                                                                                          # ;
; #     - checkHandles()                                                                                                                     # ;
...
; #     - setIP(IP)                                 - Ìåíÿåò IP Àäðåñ Ñåðâåðà       (Íå äîðàáîòàí)                                           # ;
; #     - getHostname()                             - Âûäà¸ò Èìÿ ñåðâåðà                                                                     # ;
; #     - setUsername(Username)                     - Óñòàíîâèòü íîâûé Íèê          (Íå äîðàáîòàí)                                           # ;
; #     - colorhud(Öâåò)                            - Ìåíÿåò çåë¸íûé öâåò â èãðå íà óêàçàíûé                                                 # ;
; #	    - setTime(hour)	                            - Óñòàíàâëèâàåò âðåìÿ íà ñåðâåðå                                                         # ;
; #	    - getSkinID()   	                        - Âûäà¸ò ID Ñêèíà âàøåãî ïåðñîàæà                                                        # ;
; #	    - getDialogTitle() 	                        - Âûäà¸ò Çàãîëîâîê ïîñëåäíåãî äèàëîãà                                                    # ;
...
; #     - WriteProcessMemory(title,addresse,wert,size) - Ðàáîòà ñ ïðåñåòàì                                                                   # ;
; #     - writeFloat(hProcess, dwAddress, wFloat)   - Ðàáîòà ñ ïàìÿòüþ ïðîöåññà                                                              # ;
; #     - writeByte(hProcess, dwAddress, wInt)      - Ðàáîòà ñ ïàìÿòüþ ïðîöåññà                                                              # ;
; #     - FloatToHex(value)                         - Ïåðåâîò èç Float â Hex                                                                 # ;
; #     - IntToHex(int)                             - Âûäà¸ò èíòåðüåð ïåðñîíàæà                                                              # ;
; #     - addChatMessageEx(Color, wText)            - Ôýéê ñîîáùåíèå ñ ïîêðàñêîé timstamp                                                    # ;
; #     - connect(IP)                               - Ïîäêëþ÷åíèå ê ñåðâåðó ïî åãî IP (Ïîêà ÷òî áåç ñìåíû Ïîðòà)                             # ;
; #     - HexToDec(str)                             - Ïåðåâîä èç Hex â Dec (Ñòðîêîâûõ çíà÷åíèé)                                              # ;
; #     - setWeather(id)                            - Óñòàíîâèòü ïîãîäó                                                                      # ;
; #                                                                                                                                          # ;
; ############################################################################################################################################ ;
; #                                                                                                                                          # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;                                     
; # by McFree                                                                                                                                # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; #    - getPlayerPosById(dwId)                                         - Âû÷èñëÿåò ïîçèöèþ ïåðñîíàæà                                        # ;
; #    - HexToDecOne(Hex)                                               - Ïåðåâîä èç Hex â Dec                                               # ;
; #    - HexToDecTwo(Hex)                                               - Ïåðåâîä øåñòíàäöàòèðè÷íîãî ÷èñëà â äåñÿòè÷íîå                      # ;
...
; #    - ProcessWriteMemory(Str ,addresse, process, Str, byte)          - Ðàáîòà ñ ïàìÿòüþ                                                   # ;
; #    - ProcessReadMemory(address, processIDorName, type, numBytes)    - Ðàáîòà ñ ïàìÿòüþ                                                   # ;
; #    - GetCoordsSamp(ByRef ResX, ByRef ResY)                          - Ïåðåâîä êîðäèíàò ìîíèòîðà íà êîðäèíàòû SA-MP                       # ;
; #                                                                                                                                          # ;
; ############################################################################################################################################ ;
; #                                                                                                                                          # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;    
; # by Godarck                                                                                                                               # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; #     - GetInterior()                                          - True or False. Íàõîäèòñÿ ëè ïåðñîíàæ â èíòåðüåðå èëè íåò.  
; #     - getVehicleSirenState()                                 - True or False. Âêëþ÷åíà ëè ñèðåíà â ïîëèöåéñêîé ìàøèíå èëè íåò. 
; #     - CoordsFromRedmarker()                                  - Ñ÷èòûâàåò êîîðäèíàòû ìåòêè ñ êàðòû.                
; #     - NearPlayerInCar(dist)                                  - Îïðåäåëÿåò èãðîê â àâòîìîáèëå ðÿäîì                
; #     - isTargetDriverbyId(dwId)                               - ßâëÿåòñÿ ëè èãðîê äàííîãî ID âîäèòåëåì ò/ñ         
; #     - ConvertCarColor(Color)                                 - Êîíâåðòàöèÿ öâåòà â RGB äëÿ getVehicleColor1() è getVehicleColor2() 
; #                                                                                                                                          # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; # By Unknown                                                                                                                               # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; #     - disableCheckpoint()                                - Îòêëþ÷àåò ìàðêåð íà êàðòå. Disabled REd Marker on map      
; #     - setCheckpoint(xpos,ypos,zpos,Radius)               - Óñòàíàâëèâàåò ìàðêåð íà êàðòå. Ðåêîìåíäóåìîå çíà÷åíèå ðàäèóñà   
; #                                                                                                                                          # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; # By MrGPro                                                                                                                                # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; #     - getServerHour()                                    - Ïîëó÷àåì èãðîâûõ ÷àñû ìèíóò (Òîëüêî ñåðâåðàõ ãäå ýòî îòîáðàæàåòñÿ   
; #     - getServerMinute()                                  - Ïîëó÷àåì èãðîâûõ ìèíóòû ìèíóò (Òîëüêî ñåðâåðàõ ãäå ýòî îòîáðàæàåòñÿ 
; #     - getVehicleIdServer()                               - id òðàíñïîðòà íà ñåðâåðå â êîòîðûé âû ñåëè         
; #                                                                                                                                          # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; # By Ñëþíÿâ÷èê                                                                                                                             # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; #     - IsInAFK()                                         - Ïðîâåðêà íà ÀÔÊ (1 - â ÀÔÊ 0 - íå ÀÔÊ -1 - Èãðà çàêðûòà)
; #                                                                                                                                          # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; # By Dworkin                                                                                                                               # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; #     - getCameraCoordinates()                            - Ïîëó÷åíèå êîîðäèíàòû âàøåé êàìåðû                                              # ;
; #                                                                                                                                          # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; # By Phoenixxx_Czar                                                                                                                        # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; #     - isPlayerInStreamById(player_id [, dist])                                                                                           # ;
; #             Ôóíêöèÿ äëÿ îïðåäåëåíèÿ íàõîäèòüñÿ ëè èãðîê (èãðîêè) â çîíå ñòðèìà                                                           # ;
; #             player_id - èä èãðîêà èëè ìàññèâ èäîâ èãðîêîâ                                                                                # ;
; #             radius - ðàäèóñ ïîèñêà èãðîêîâ îòíîñèòåëüíî îñíîâíîãî ïåðñîíàæà                                                              # ;
; #     - getIdsInAnyVehicle()                              - Âûäàåò êòî ñ âàìè â àâòîìîáèëå                                                 # ;
; #     - setPlayerName(playerid, newnick)                  - Âèçóàëüíàÿ ñìåíà Íèê Íýéìà ëþáîãî èãðîêà                                       # ;
; #     - getDialogLineNumber()                             - Îïðåäåëÿåò âûáðàíóþ ñòðîêó â äèàëîãå                                           # ;
; #     - getsexbyskin(skin)                                - Îïðåäåëÿåò ïîë ïî èäó ñêèíà (0 - Îøèáêà, 1 - Ìóæñêîé, 2 - Æåíñêèé)             # ;
; #     - save(var)                                         - Ñîõðàíÿåò ïî äàòàì â                                                           # ;
; #                                                           "Ìîè Äîêóìåíòû -> GTA San Andreas User Files -> SAMP -> ChatLogs"              # ;
; #     - copy(text)                                        - Êîïèðóåò â áóôåð                                                               # ;
; #     - GetText(array [, min, max, button])               - Èç ìàññèâ â òåêñò ñ ïåðåíîñàìè ñ îãðàíè÷åíèåì                                  # ;
; #     - Get(url)                                          - Get çàïðîñ íà óêàçàííûé url, âûäàåò òåêñò ñ ñàéòà                              # ;
; #     - Post(url, send)                                   - Post çàïðîñ íà ñàéò (0 - Âñå õîðîøî \ 1 - Îøèáêà)                              # ;
; #                                                                                                                                          # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; # By Revalto                                                                                                                               # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; #     - setCoordinatesCar(x, y, z)         - Òåëåïîðò ïåðñîíàæà ñ Òðàíñïîðòîì                                                              # ;
; #                                                                                                                                          # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; # ×ÈÒÛ                                                                                                                                     # ;
; #------------------------------------------------------------------------------------------------------------------------------------------# ;
; #     - toggleUnlimitedAmmo()                             - áåñêîíå÷íûå ïàòðîíû 
; #     - toggleNoReload()                                  - ñòðåëüáà áåç ïåðåçàðÿäêè 
; #     - toggleNoRecoil()                                  - ñòðåëüáà áåç îòäà÷è 
; #     - toggleAntiBikeFall()                              - íå ïàäàòü ñ áàéêà 
; #     - toggleAntiCarEject()                              - âàñ íå ìîãóò âûêèíóòü èç ìàøèíû 
; #     - toggleNoAnimations()                              - àíèìàöèè íå îòîáðàæàþòñÿ 
; #     - toggleObjectDrawMode()                            - êóðñîð äëÿ îòîáðàæåíèÿ èíôîðìàöèè î streamer îáúåêòàõ íà ñåðâåðå 
; #     - toggleMotionBlur()                                - ðàçìûòîñòü ïðè äâèæåíèè íà áîëüøîé ñêîðîñòè êàê â ñèíãëå 
; #     - writeBytes(hProcess, dwAddress, bytes)            - çàïèñàòü íåñêîëüêî áàéòîâ ïî àäðåñó (ñëóæåáíàÿ ôóíêöèÿ)
; #     - setFireImmunity(state)                            - Èìóíèòåò îò îãíÿ (0-âûêë, 1-âêë)
; #     - setInfiniteRun(state)                             - Áåñê áåã (0-âûêë, 1-âêë)
; #     - isMarkerSetup()                                   - Ñòîèò ëè ìàðêåð íà êðàòå (-1 îøèáêà, 0 íåò, 1 äà)
; #                   
; ############################################################################################################################################ ;
...
{ 
    ...
    TextLen :=StrLen(Text) 
    HmemText :=DllCall("GlobalAlloc", "UInt", GMEM_MOVEABLE, "UInt", TextLen+1) ; Çàïðîñ ïåðåìåùàåìîé 
    HmemLocale:=DllCall("GlobalAlloc", "UInt", GMEM_MOVEABLE, "UInt", 4) ; ïàìÿòè, âîçâðàùàþòñÿ õýíäëû. 
    If(!HmemText || !HmemLocale) 
        Return 
    PtrText :=DllCall("GlobalLock", "UInt", HmemText) ; Ôèêñàöèÿ ïàìÿòè, õýíäëû êîíâåðòèðóþòñÿ 
    PtrLocale :=DllCall("GlobalLock", "UInt", HmemLocale) ; â óêàçàòåëè (àäðåñà). 
    DllCall("msvcrt\memcpy", "UInt", PtrText, "Str", Text, "UInt", TextLen+1, "Cdecl") ; Êîïèðîâàíèå òåêñòà. 
    NumPut(LocaleID, PtrLocale+0) ; Çàïèñü èäåíòèôèêàòîðà ëîêàëè. 
    DllCall("GlobalUnlock", "UInt", HmemText) ; Ðàñôèêñàöèÿ ïàìÿòè. 
    DllCall("GlobalUnlock", "UInt", HmemLocale) 
    If not DllCall("OpenClipboard", "UInt", 0) ; Îòêðûòèå áóôåðà îáìåíà. 
    { 
        DllCall("GlobalFree", "UInt", HmemText) ; Îñâîáîæäåíèå ïàìÿòè, 
        DllCall("GlobalFree", "UInt", HmemLocale) ; åñëè îòêðûòü íå óäàëîñü. 
        Return 
    } 
    DllCall("EmptyClipboard") ; Î÷èñòêà. 
    DllCall("SetClipboardData", "UInt", CF_TEXT, "UInt", HmemText) ; Ïîìåùåíèå äàííûõ. 
    DllCall("SetClipboardData", "UInt", CF_LOCALE, "UInt", HmemLocale) 
    DllCall("CloseClipboard") ; Çàêðûòèå. 
} 
...
ClipGetText(CodePage=1251) 
{
    ...
    Loop 
    { 
        Format:=DllCall("EnumClipboardFormats", "UInt", Format) ; Ïåðåáîð ôîðìàòîâ. 
        If(Format=0 || Format=CF_TEXT || Format=CF_UNICODETEXT) 
            Break 
    } 
    If(Format=0) { ; Òåêñòà íå íàéäåíî. 
        DllCall("CloseClipboard") 
        Return 
    } 
    If(Format=CF_TEXT) 
    { 
        HmemText:=DllCall("GetClipboardData", "UInt", CF_TEXT) ; Ïîëó÷åíèå õýíäëà äàííûõ. 
        PtrText :=DllCall("GlobalLock", "UInt", HmemText) ; Êîíâåðòàöèÿ õýíäëà â óêàçàòåëü. 
        TextLen :=DllCall("msvcrt\strlen", "UInt", PtrText, "Cdecl") ; Èçìåðåíèå äëèíû íàéäåííîãî òåêñòà. 
        VarSetCapacity(Text, TextLen+1) ; Ïåðåìåííàÿ ïîä ýòîò òåêñò. 
        DllCall("msvcrt\memcpy", "Str", Text, "UInt", PtrText, "UInt", TextLen+1, "Cdecl") ; Òåêñò â ïåðåìåííóþ. 
        DllCall("GlobalUnlock", "UInt", HmemText) ; Ðàñôèêñàöèÿ ïàìÿòè. 
    } 
    Else If(Format=CF_UNICODETEXT) 
    {
        ...
        , "UInt", 0, "Int", 0) ; Êîíâåðòàöèÿ èç Unicode â ANSI. 
        ...
        If (DllCall("Module32First", "Uint", snapMod, "Uint", &me32))
        {
            Loop
            {
                If (!DllCall("lstrcmpi", "Str", "samp.dll", "UInt", &me32 + 32)) {
                    ...
                    key:= NumGet(&me32 + 20)
                    WinGet, PID_SAMP, PID, Criminal Russia Multiplayer Ðåâèçèÿ G
...
; Âèçóàëüíî ìåíÿåò íèê ëþáîãî èãðîêà
...
initZonesAndCities() {
    ...
    AddCity("Ëàñ-Âåíòóðàñ", 685.0, 476.093, -500.0, 3000.0, 3000.0, 500.0)
    AddCity("Ñàí-Ôèåððî", -3000.0, -742.306, -500.0, -1270.53, 1530.24, 500.0)
    AddCity("Ñàí-Ôèåððî", -1270.53, -402.481, -500.0, -1038.45, 832.495, 500.0)
    AddCity("Ñàí-Ôèåððî", -1038.45, -145.539, -500.0, -897.546, 376.632, 500.0)
    AddCity("Ëîñ-Ñàíòîñ", 480.0, -3000.0, -500.0, 3000.0, -850.0, 500.0)
    AddCity("Ëîñ-Ñàíòîñ", 80.0, -2101.61, -500.0, 1075.0, -1239.61, 500.0)
    AddCity("Òüåððà-Ðîáàäà", -1213.91, 596.349, -242.99, -480.539, 1659.68, 900.0)
    AddCity("Ðåä-Êîóíòè", -1213.91, -768.027, -242.99, 2997.06, 596.349, 900.0)
    AddCity("Ôëèíò-Êîóíòè", -1213.91, -2892.97, -242.99, 44.6147, -768.027, 900.0)
    AddCity("Óýòñòîóí", -2997.47, -2892.97, -242.99, -1213.91, -1115.58, 900.0)
...
{ 
    ...
    address=0xBAB230
    WinGet ,idvar,PID,Criminal Russia Multiplayer Ðåâèçèÿ G
    processhandle:=DllCall("OpenProcess","Uint",0x38,"int",0,"int",idvar) 
...
; ##### SAMP-Funktionen #####
; Ôóíêöèÿ äëÿ îïðåäåëåíèÿ âñåõ èäîâ â àâòîìîáèëå
getIdsInAnyVehicle()
{
...
isPlayerInStreamById(player_id, radius := 150)
{
	...
	For i, o in p ; áåðåò èãðîêîâ èç ñòðèìà â ïåðåìåííóþ NAME
	{
	...
	if (IsObject(player_id)) ; Åñëè ïîëó÷åí ìàññèâ
	{
		
		for k, v in player_id ; Ïðîâåðÿåò íàõîäèòüñÿ ëè èä èç ìàññèâà â çîíå ñòðèìà
		{
			i := 0
			Loop, Parse, % NAME, % ",", % " ,.`n`r"
			{
	...
	else if (!IsObject(player_id)) ; åñëè ïåðåäàí èä
	{
...
;=================================================[Ðàáîòà ñ ïàìÿòüþ]===================================================================================
; Èñòî÷íèê - http://dumpz.org/2345353/
...
IsInAFK() {
    ...
    if (res==-1)
        return -1
    WinGet, win, MinMax, Criminal Russia Multiplayer Ðåâèçèÿ G
...
GetChatLine(Line, ByRef Output, timestamp=0, color=0){
	chatindex := 0
	FileRead, file, %A_MyDocuments%\GTA San Andreas User Files\CR-MP\GenerationC\chatlog.txt
	loop, Parse, file, `n, `r
	{
		if(A_LoopField)
			chatindex := A_Index
...
calculateCity(posX, posY, posZ) {
    ...
    Loop % nCity-1
    {
        if (posX >= city%A_Index%_x1) && (posY >= city%A_Index%_y1) && (posZ >= city%A_Index%_z1) && (posX <= city%A_Index%_x2) && (posY <= city%A_Index%_y2) && (posZ <= city%A_Index%_z2)
        {
            ...
            if (smallestCity == "Íåèçâåñòíî") || (currentCitySize < smallestCitySize)
            {
...
; internal stuff
refreshGTA() {
    newPID := getPID("Criminal Russia Multiplayer Ðåâèçèÿ G")
...
FileDelete, %A_ScriptDir%/AHELP.exe
sleep 1000
FileMove, %A_ScriptDir%/AHELP2.exe, %A_ScriptDir%/AHELP.exe
SplashTextOn, , 60, �������� ����������, ������ �������...
Sleep 1000
run, %A_ScriptDir%/AHELP.exe
SplashTextOff
ExitApp